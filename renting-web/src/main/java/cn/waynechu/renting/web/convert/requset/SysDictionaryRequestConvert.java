...
public class SysDictionaryRequestConvert {
    ...
    public static SysDictionaryDTO toSysDictionaryDTO(SysDictionaryCreateRequest sysDictionaryCreateRequest) {
        return BeanUtil.beanTransfer(sysDictionaryCreateRequest, SysDictionaryDTO.class);
    }
