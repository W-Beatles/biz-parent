package cn.waynechu.web.aspect;

import cn.waynechu.api.common.aspect.AbstractControllerLogAspect;
...
public class ControllerLogAspect extends AbstractControllerLogAspect {
    ...
    @Pointcut("execution(* cn.waynechu.web.controller.*Controller.*(..))")
    @Override
