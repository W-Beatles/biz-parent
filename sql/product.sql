...
CREATE TABLE `tbl_product`  (
  ...
  `product_status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '产品状态：0下架，1上架',
  `total` int(10) NOT NULL DEFAULT '0' COMMENT '总量',
  `used` int(10) NOT NULL DEFAULT '0' COMMENT '使用量',
  `residue` int(10) NOT NULL DEFAULT '0' COMMENT '剩余量',
...
-- ----------------------------
INSERT INTO `tbl_product` VALUES (1, '产品A', 1, 100, 0, 100, '2019-09-20 15:03:27', '2019-09-20 15:03:27');
