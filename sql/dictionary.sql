...
CREATE TABLE `dictionary`  (
  ...
  `dic_type_code` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '类型编码',
  ...
  INDEX `idx_dic_type_code_dic_code`(`dic_type_code`, `dic_code`) USING BTREE COMMENT '类型编码字典编码索引'
