...
echo "==== 1.starting biz-spring-cloud-eureka-peer1(9001), biz-spring-cloud-eureka-peer2(9002) ===="
nohup java -jar \
        ...
        ./biz-spring-cloud-eureka/target/biz-spring-cloud-eureka-0.0.1-SNAPSHOT.jar &
nohup java -jar \
        -Denv=PRO -Dapollo.meta=http://apollo.waynechu.cn:8080 \
