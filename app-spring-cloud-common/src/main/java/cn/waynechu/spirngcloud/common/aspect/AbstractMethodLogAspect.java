package cn.waynechu.spirngcloud.common.aspect;

import cn.waynechu.spirngcloud.common.annotation.MethodLogAnnotation;
import cn.waynechu.spirngcloud.common.util.DequeThreadLocalUtil;
...
public abstract class AbstractMethodLogAspect {
    ...
    @Pointcut("@annotation(cn.waynechu.spirngcloud.common.annotation.MethodLogAnnotation)")
